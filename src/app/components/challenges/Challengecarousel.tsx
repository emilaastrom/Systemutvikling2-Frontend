...
const Challengecarousel = () => {
    ...
    return (
        <div className="flex z-10 self-start w-screen text-black overflow-x-auto overflow-y-auto customized-scrollbar">
            {activeChallenges.map((challenge, index) => {
                var startDateParts =
                    challenge.assignedChallenge.startDate.split("-");
                ...
                var endDateParts =
                    challenge.assignedChallenge.endDate.split("-");
                ...
                var numberOfTrue = challenge.assignedChallenge.subStatus.filter(
                    function (value) {
                        return value === true;
                    }
                ).length;
